...
void initialiseTimers()
{
  ...
  Timer4.resume(); //Start Timer
    ...
    // initialise time components in the PSOC5 device
    initTimebase();

    // Dedicated timer is created in the PSOC5 Speeduino Arduino version
    Counter_1ms_initialize();
    Counter_1ms_attachinterupt(oneMSInterval);
...
#elif defined (CORE_TEENSY) || defined(CORE_STM32) || defined(CORE_PSOC5)
...
#endif
{
...
#ifndef CORE_PSOC5 // Timing is handled by hardware/timers in the PSOC5 implementation
  ...
  //Loop executed every 100ms - 10Hz
  if (loop100ms == 100)
  {
  ...
  //Loop executed every 250ms loop - 4Hz
  if (loop250ms == 250)
  {
  ...
  //Loop executed every 1 second - 1Hz
  if (loopSec == 1000)
  {
