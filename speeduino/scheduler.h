...
#define SCHEDULER_H
  ...
  // Add real PSOC5 code, currently only dummy definitions
  #define MAX_TIMER_PERIOD 131070 //The longest period of time (in uS) that the timer can permit (IN this case it is 65535 * 2, as each timer tick is 2uS)
  #define MAX_TIMER_PERIOD_SLOW 131070 //The longest period of time (in uS) that the timer can permit (IN this case it is 65535 * 2, as each timer tick is 2uS)
  #define uS_TO_TIMER_COMPARE(uS) (uS >> 1) //Converts a given number of uS into the required number of timer ticks until that time has passed.
  #define uS_TO_TIMER_COMPARE_SLOW(uS) (uS >> 1) //Converts a given number of uS into the required number of timer ticks until that time has passed.
...
// Dummy
  ...
  #define FUEL1_COMPARE TEMP
  #define FUEL2_COMPARE TEMP
  #define FUEL3_COMPARE TEMP
  #define FUEL4_COMPARE TEMP
  #define FUEL5_COMPARE TEMP

  #define IGN1_COMPARE TEMP
  #define IGN2_COMPARE TEMP
  #define IGN3_COMPARE TEMP
  #define IGN4_COMPARE TEMP
  #define IGN5_COMPARE TEMP

  #define FUEL1_TIMER_ENABLE()  //Turn on the A compare unit (ie turn on the interrupt)
  #define FUEL2_TIMER_ENABLE()  //Turn on the B compare unit (ie turn on the interrupt)
  #define FUEL3_TIMER_ENABLE()  //Turn on the C compare unit (ie turn on the interrupt)
  #define FUEL4_TIMER_ENABLE()  //Turn on the B compare unit (ie turn on the interrupt)
  #define FUEL5_TIMER_ENABLE()  //Turn on the B compare unit (ie turn on the interrupt)

  #define FUEL1_TIMER_DISABLE()  //Turn off this output compare unit
  #define FUEL2_TIMER_DISABLE()  //Turn off this output compare unit
  #define FUEL3_TIMER_DISABLE()  //Turn off this output compare unit
  #define FUEL4_TIMER_DISABLE()  //Turn off this output compare unit
  #define FUEL5_TIMER_DISABLE()  //Turn off this output compare unit

  #define IGN1_TIMER_ENABLE()  //Turn on the A compare unit (ie turn on the interrupt)
  #define IGN2_TIMER_ENABLE()  //Turn on the B compare unit (ie turn on the interrupt)
  #define IGN3_TIMER_ENABLE()  //Turn on the C compare unit (ie turn on the interrupt)
  #define IGN4_TIMER_ENABLE()  //Turn on the A compare unit (ie turn on the interrupt)
  #define IGN5_TIMER_ENABLE()  //Turn on the A compare unit (ie turn on the interrupt)

  #define IGN1_TIMER_DISABLE() //Turn off this output compare unit
  #define IGN2_TIMER_DISABLE()  //Turn off this output compare unit
  #define IGN3_TIMER_DISABLE()  //Turn off this output compare unit
  #define IGN4_TIMER_DISABLE()  //Turn off this output compare unit
  #define IGN5_TIMER_DISABLE()  //Turn off this output compare unit
  // End PSOC5 definitions
#endif
